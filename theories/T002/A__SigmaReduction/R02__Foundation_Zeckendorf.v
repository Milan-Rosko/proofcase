...
Lemma pair_P0_as_odd_even_sum :
  forall x y,
    pair P0 x y = sum_fib (odd_band P0 x y ++ even_band P0 x).
Proof.
  intros x y.
  unfold pair.
  rewrite !sum_fib_app.
