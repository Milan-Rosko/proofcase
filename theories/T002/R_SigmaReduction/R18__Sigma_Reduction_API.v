...
Definition HaltingTrace
  (e input fuel : nat) (st : R16__Sigma_Reduction.RMState) (b : bool) : Prop :=
  R16__Sigma_Reduction.HaltingTrace e input fuel st b.
...
Theorem eval_rm_iff_halting_trace :
  forall e input b,
    EvalRM e input b <->
    exists fuel st, HaltingTrace e input fuel st b.
Proof.
  exact R16__Sigma_Reduction.EvalRM_iff_halting_trace.
Qed.
