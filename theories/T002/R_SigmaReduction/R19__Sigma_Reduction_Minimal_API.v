...
Definition HaltingTrace
  (e input fuel : nat) (st : T002.R16__Sigma_Reduction.RMState) (b : bool) : Prop :=
  R18__Sigma_Reduction_API.HaltingTrace e input fuel st b.
...
Proof.
  exact R18__Sigma_Reduction_API.eval_rm_iff_halting_trace.
Qed.
